...
# -- 탐색 그리드 --
SL_SLOPE_BONUS_LIST = [0.0, 0.1, 0.2]
RELAX_VOL_MOM_TH_LIST = [0.08, 0.12, 0.20]
RELAX_FACTOR_LIST = [0.3, 0.5, 0.7]
...
def main() -> None:
    ...
    print(f"  c191 최적 (slB={best['sl_slope_bonus']:.1f} "
          f"rTh={best['relax_vol_mom_th']:.2f} "
          f"rF={best['relax_factor']:.1f}): "
