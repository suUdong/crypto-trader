"""
momentum_sol 슬라이딩 윈도우 다중 OOS 검증 (사이클 74)
- 목적: 사이클 73 통과 C1(lb=12, adx=25, vol=2.0, TP=12%, SL=4%) 단일구간 한계 보완
...
# C1 vs C0 비교
CANDIDATES = [
    {"lookback": 12, "adx": 25.0, "vol_mult": 2.0, "tp": 0.12, "sl": 0.04, "label": "C1 (lb=12 adx=25) ★검증대상"},
...
def main() -> None:
    print("=" * 80)
    print("momentum_sol 슬라이딩 윈도우 다중 OOS 검증 (사이클 74)")
    print("목적: C1(lb=12, adx=25) 단일구간 한계 극복 → 3구간 안정성 확인")
    print("=" * 80)
